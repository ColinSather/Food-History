    ...
    <div className={styles.footer}>
      <div className={styles['contact-section']}>
        <div className={styles.phone}>
          ...
          <span className={styles.text01}>+40 (0)364 101 203</span>
        </div>
        <div className={styles.address}>
          <span className={styles.text02}>Address</span>
          <span className={styles.text03}>Calea Motilor no 84, Cluj-Napoca</span>
        </div>
      </div>
      <div className={styles['footer-menu']}>
        <div className={styles.footersection}>
          <span className={styles.text04}>HELP AND ADVICE</span>
          <span className={styles.text05}>If you have any questions</span>
          <span className={styles.text06}>Or you need more support</span>
          <a
            href="mailto:hello@teleporthq.io"
            target="_blank"
            rel="noreferrer noopener"
            className={` ${projectStyles.thqLink} ${styles.text07} `}
          >
            Drop us a line.
          </a>
        </div>
        <div className={styles.footersection1}>
          <span className={styles.text08}>COMPANY</span>
          <span className={styles.text09}>If you want to know more</span>
          <span className={styles.text10}>About our team or technology</span>
          <a
            href="https://teleporthq.io/"
            target="_blank"
            rel="noreferrer noopener"
            className={` ${projectStyles.thqLink} ${styles.text11} `}
          >
        ...
        <div className={styles['get-in-touch']}>
          <FooterSection
            text="Feel free to get in touch with us via email."
            text1=" "
            text2=" "
            text3=" "
            title="GET IN TOUCH"
          ...
          <div className={styles.email}>
            ...
            <span className={styles.text12}>hello@teleporthq.io</span>
          </div>
        </div>
      </div>
      <div className={styles.bottom}>
        <div className={styles['social-media']}>
          ...
          <svg
            ...
            height="30"
            viewBox="0 0 1024 1024"
            className={` ${projectStyles.thqIcon} ${styles.svg} `}
          >
